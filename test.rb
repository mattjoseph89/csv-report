...
puts ("groceries #{pgroceries_totals.sum} #{pgroceries_average.round(2)}")
...
puts ("#{sgroceries_totals.sum} #{sgroceries_average.round(2)}")
puts ("#{seducation_totals.sum} #{seducation_average.round(2)}")
puts ("#{sgifts_totals.sum} #{sgifts_average.round(2)}")
puts ("#{sgym_totals.sum} #{sgym_average.round(2)}")
puts ("#{smed_totals.sum} #{smed_average.round(2)}")
